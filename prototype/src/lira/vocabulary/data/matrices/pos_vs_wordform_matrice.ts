...
export const WORD_FORM_MATRIX: readonly WordFormRow[] = [
  {
    wordformType: WordFormType.BASE_LEMMA_CANONICAL_FORM,
  ...
  {
    wordformType: WordFormType.SINGULAR_NUMBER_FORM,
  ...
  {
    wordformType: WordFormType.PLURAL_NUMBER_FORM,
  ...
  {
    wordformType: WordFormType.PRESENT_TENSE_FORM,
  ...
  {
    wordformType: WordFormType.PRESENT_TENSE_INSTANCE_FORM,
  ...
  {
    wordformType: WordFormType.PAST_TENSE_FORM,
  ...
  {
    wordformType: WordFormType.PAST_TENSE_INSTANCE_FORM,
  ...
  {
    wordformType: WordFormType.THIRD_PERSON_SINGULAR_PRESENT_FORM,
  ...
  {
    wordformType: WordFormType.PRESENT_PARTICIPLE_FORM,
  ...
  {
    wordformType: WordFormType.PAST_PARTICIPLE_FORM,
  ...
  {
    wordformType: WordFormType.BARE_INFINITIVE_FORM,
  ...
  {
    wordformType: WordFormType.MODAL_FORM,
    label: "Modal Form",
    purpose:
  ...
  {
    wordformType: WordFormType.SECONDARY_MODAL_FORM,
  ...
  {
    wordformType: WordFormType.POSITIVE_DEGREE_FORM,
  ...
  {
    wordformType: WordFormType.COMPARATIVE_DEGREE_FORM,
  ...
  {
    wordformType: WordFormType.COMPARATIVE_PERIPHRASTIC_FORM,
  ...
  {
    wordformType: WordFormType.SUPERLATIVE_DEGREE_FORM,
  ...
  {
    wordformType: WordFormType.SUPERLATIVE_PERIPHRASTIC_FORM,
  ...
  {
    wordformType: WordFormType.FIRST_PERSON_FORM,
  ...
  {
    wordformType: WordFormType.SECOND_PERSON_FORM,
  ...
  {
    wordformType: WordFormType.THIRD_PERSON_FORM,
  ...
  {
    wordformType: WordFormType.SUBJECTIVE_CASE_FORM,
  ...
  {
    wordformType: WordFormType.OBJECTIVE_CASE_FORM,
  ...
  {
    wordformType: WordFormType.POSSESSIVE_CASE_FORM,
  ...
  {
    wordformType: WordFormType.CONSONANT_SOUND_FORM,
  ...
  {
    wordformType: WordFormType.VOWEL_SOUND_FORM,
  ...
  {
    wordformType: WordFormType.REFLEXIVE_CASE_FORM,
 ...
 * Pattern" column, flattened across every rule for `wordformType` whose
 ...
 * literal one). */
export function stringPatternsFor(wordformType: WordFormType, pos: PartOfSpeech): readonly string[] {
  const row = WORD_FORM_MATRIX.find((r) => r.wordformType === wordformType);
...
export function fieldsFor(pos: PartOfSpeech): readonly WordFormType[] {
  return WORD_FORM_MATRIX.filter((row) => row.rules.some((rule) => rule.appliesTo.includes(pos))).map((row) => row.wordformType);
}
