...
if __name__ == "__main__":
    ...
    # regenerated by common_definition_gap_vocabulary_seeding.py instead,
    # not here -- that script seeds this same Physics Domain and then adds
    # the 1163-word Common definition-gap batch on top, so it reflects the
    # fuller, more complete state. Regenerating it from this run alone
    # would silently regress it back to an earlier, less complete state.
