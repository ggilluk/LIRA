...
Linguistics; DictionaryEntry.meaning is a value_objects Text rather
than a plain str), agents/ (VocabularyAgent and concrete agents),
role/ (DictionaryProcessor, AsyncDictionaryHydrator,
ExternalDictionaryAdapter -- the lexicon and everything that
seeds/looks up/hydrates it belong here, not Linguistics),
