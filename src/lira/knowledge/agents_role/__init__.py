...
Also holds DomainController and DomainAgent (domain_controller.py,
domain_agent.py) -- per the Repository Layout rule, Knowledge is the
repository's home for core Agents/Role types generally, not just
Knowledge-layer-specific ones (same as Domain and LIRAHost living in
data_classes/)."""
