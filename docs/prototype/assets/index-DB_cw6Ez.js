var N=Object.defineProperty;var I=(a,e,r)=>e in a?N(a,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):a[e]=r;var o=(a,e,r)=>I(a,typeof e!="symbol"?e+"":e,r);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&t(i)}).observe(document,{childList:!0,subtree:!0});function r(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function t(n){if(n.ep)return;n.ep=!0;const s=r(n);fetch(n.href,s)}})();class T{constructor(){o(this,"statuses",new Map);o(this,"listeners",new Set)}register(e,r,t="idle",n){this.statuses.set(e,{id:e,label:r,state:t,detail:n}),this.notify()}update(e,r,t,n){const s=this.statuses.get(e);s&&(this.statuses.set(e,{...s,state:r,detail:t,progress:n}),this.notify())}get(e){return this.statuses.get(e)}all(){return[...this.statuses.values()]}subscribe(e){return this.listeners.add(e),e(this.all()),()=>{this.listeners.delete(e)}}notify(){const e=this.all();for(const r of this.listeners)r(e)}}class L{constructor(e=[]){o(this,"domains",new Map);for(const r of e)this.add(r)}add(e){this.domains.set(e.name,e)}get(e){return this.domains.get(e)}all(){return[...this.domains.values()]}roots(){return this.all().filter(e=>e.parentName===void 0)}children(e){return this.all().filter(r=>r.parentName===e)}ancestryOf(e){const r=[];let t=this.get(e);for(;t!==void 0;)r.unshift(t),t=t.parentName!==void 0?this.get(t.parentName):void 0;return r}}class B{constructor(e,r="LIRA"){o(this,"unsubscribe");this.board=e,this.title=r}mount(e){var r;this.ensureStyles(),(r=this.unsubscribe)==null||r.call(this),this.unsubscribe=this.board.subscribe(t=>{e.innerHTML=this.renderScreen(t)})}waitFor(...e){return new Promise(r=>{const t=i=>i==="done"||i==="error",n=i=>{const c=i.filter(p=>e.includes(p.id));c.length===e.length&&c.every(p=>t(p.state))&&(s(),r())},s=this.board.subscribe(n)})}destroy(){var e;(e=this.unsubscribe)==null||e.call(this),this.unsubscribe=void 0}renderScreen(e){return`
    ...
    `}ensureStyles(){if(document.getElementById(v))return;const e=document.createElement("style");e.id=v,e.textContent=M,document.head.appendChild(e)}}const A={"not-ported":"Not ported yet",idle:"Waiting…",running:"Working…",done:"Ready",error:"Failed"},D={"not-ported":"–",idle:"○",running:'<span class="loading-spinner"></span>',done:"✓",error:"✕"};function f(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const v="lira-loading-screen-styles",M=`
.loading-screen {
...
`;class O{constructor(e,r=[]){o(this,"unsubscribe");o(this,"collapsed",!1);this.board=e,this.actions=r}mount(e){var r;this.ensureStyles(),(r=this.unsubscribe)==null||r.call(this),e.addEventListener("click",t=>this.handleClick(t,e)),this.unsubscribe=this.board.subscribe(t=>{e.innerHTML=this.renderPanel(t)})}destroy(){var e;(e=this.unsubscribe)==null||e.call(this),this.unsubscribe=void 0}handleClick(e,r){const t=e.target.closest("[data-action]");if(!(!t||t.disabled)){if(t.dataset.action==="toggle")this.collapsed=!this.collapsed,r.innerHTML=this.renderPanel(this.board.all());else if(t.dataset.action==="run"){const n=this.actions.find(s=>s.id===t.dataset.actionId);n==null||n.onClick()}}}renderPanel(e){const r=e.filter(t=>t.state==="running"||t.state==="done").length;return`
      <div class="service-status-panel ${this.collapsed?"collapsed":""}">
        <button type="button" class="service-status-header" data-action="toggle" aria-expanded="${!this.collapsed}">
          ...
          <span class="service-status-chevron">${V}</span>
        </button>
    ...
    `}ensureStyles(){if(document.getElementById(b))return;const e=document.createElement("style");e.id=b,e.textContent=z,document.head.appendChild(e)}}const F={"not-ported":"Not ported",idle:"Idle",running:"Running",done:"Running",error:"Error"};function m(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const V='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 6l4 4 4-4"/></svg>',b="lira-service-status-styles",z=`
...
`;var d=(a=>(a[a.NOUN=0]="NOUN",a[a.VERB=1]="VERB",a[a.ADJECTIVE=2]="ADJECTIVE",a[a.ADVERB=3]="ADVERB",a[a.PRONOUN=4]="PRONOUN",a[a.DETERMINER=5]="DETERMINER",a[a.PREPOSITION=6]="PREPOSITION",a[a.CONJUNCTION=7]="CONJUNCTION",a[a.INTERJECTION=8]="INTERJECTION",a[a.NUMERAL=9]="NUMERAL",a[a.PARTICLE=10]="PARTICLE",a[a.AUXILIARY=11]="AUXILIARY",a[a.PROPER_NOUN=12]="PROPER_NOUN",a[a.SYMBOL=13]="SYMBOL",a[a.PUNCTUATION=14]="PUNCTUATION",a[a.OTHER=15]="OTHER",a))(d||{});const P={[d[d.NOUN]]:"#3B6EA5",[d[d.PROPER_NOUN]]:"#274472",[d[d.VERB]]:"#B2542D",[d[d.ADJECTIVE]]:"#7A5CA6",[d[d.ADVERB]]:"#B08900",[d[d.PRONOUN]]:"#5B7B6F",[d[d.DETERMINER]]:"#6E7B8B",[d[d.PREPOSITION]]:"#7B6E5B",[d[d.CONJUNCTION]]:"#6B7280",[d[d.PARTICLE]]:"#8A7B6E",[d[d.AUXILIARY]]:"#5B6E8B",[d[d.INTERJECTION]]:"#C2544B",[d[d.NUMERAL]]:"#4B8A7B",[d[d.SYMBOL]]:"#8A8A8A",[d[d.PUNCTUATION]]:"#9A9A9A",[d[d.OTHER]]:"#7A7A7A"},g={VALID:"#2B6E63",UNRESOLVED:"#B08900",INVALID:"#B2542D"},w=["A meaning is a representation.","The word over the meaning.","The use is a state.","The word wants to use the meaning.","The meaning and the word perceive the state."],y="lira-sentence-reader-styles";class q{constructor(e){o(this,"container");o(this,"reading",!1);o(this,"requestToken",0);o(this,"documentResult");o(this,"expandedNodes",new Set);o(this,"selectedKey");o(this,"detailCache",new Map);o(this,"detailToken",0);this.client=e}mount(e){this.container=e,this.ensureStyles(),e.innerHTML=this.renderShell(),this.wire();const r=e.querySelector(".lira-sr-textarea");r!=null&&r.value&&this.read(r.value)}destroy(){this.container=void 0}wire(){const e=this.container;if(!e)return;const r=e.querySelector(".lira-sr-textarea"),t=e.querySelector(".lira-sr-read-btn");r&&t&&(t.addEventListener("click",()=>void this.read(r.value)),r.addEventListener("keydown",s=>{(s.metaKey||s.ctrlKey)&&s.key==="Enter"&&this.read(r.value)})),e.querySelectorAll(".lira-sr-example").forEach(s=>{s.addEventListener("click",()=>{const i=s.dataset.example??"";r&&(r.value=i),this.read(i)})});const n=e.querySelector(".lira-sr-tree");n==null||n.addEventListener("click",s=>this.handleTreeClick(s)),n==null||n.addEventListener("keydown",s=>this.handleTreeKeydown(s))}handleTreeClick(e){const r=e.target,t=r.closest('[data-action="toggle-node"]');if(t){this.toggleNode(t.dataset.node??"");return}const n=r.closest('.lira-tree-row[data-kind="sentence"]');n&&this.selectSentenceNode(n.dataset.node??"")}handleTreeKeydown(e){if(e.key!=="Enter"&&e.key!==" ")return;const r=e.target.closest('.lira-tree-row[data-kind="sentence"]');r&&(e.preventDefault(),this.selectSentenceNode(r.dataset.node??""))}toggleNode(e){!e||!this.documentResult||(this.expandedNodes.has(e)?this.expandedNodes.delete(e):this.expandedNodes.add(e),this.renderTreeInPlace())}renderTreeInPlace(){var r;if(!this.documentResult)return;const e=(r=this.container)==null?void 0:r.querySelector(".lira-sr-tree");e&&(e.innerHTML=this.renderTree(this.documentResult))}async selectSentenceNode(e){const r=this.documentResult,t=j(e);if(!r||!t)return;const n=r.blocks[t.blockIndex];if(!n||n.blockKind!=="paragraph")return;const s=n.sentences[t.sentenceIndex];if(!s)return;this.selectedKey=e,this.expandedNodes.add(`b${t.blockIndex}`),this.renderTreeInPlace();const i=this.detailCache.get(e);if(i){this.renderDetail(i);return}this.setPanelPlaceholder(".lira-sr-predicted","Loading…"),this.setPanelPlaceholder(".lira-sr-winner-panel","Loading…"),this.setPanelPlaceholder(".lira-sr-trace","Loading…");const c=++this.detailToken,p=this.isLearningEnabled();try{const u=await this.client.read(s.text,p,!0);if(c!==this.detailToken||!this.container)return;this.detailCache.set(e,u),this.renderDetail(u)}catch(u){if(c!==this.detailToken||!this.container)return;this.setError(u instanceof Error?u.message:String(u))}}isLearningEnabled(){var r;const e=(r=this.container)==null?void 0:r.querySelector(".lira-sr-learning-toggle");return(e==null?void 0:e.checked)??!0}async read(e){const r=e.trim();if(!r||this.reading)return;const t=++this.requestToken,n=this.isLearningEnabled();this.reading=!0,this.setBusy(!0),this.setError(void 0);try{const s=await this.client.readDocument(r,n);if(t!==this.requestToken||!this.container)return;this.renderDocument(s)}catch(s){if(t!==this.requestToken||!this.container)return;this.setError(s instanceof Error?s.message:String(s))}finally{t===this.requestToken&&(this.reading=!1,this.setBusy(!1))}}setBusy(e){var t;const r=(t=this.container)==null?void 0:t.querySelector(".lira-sr-read-btn");r&&(r.disabled=e,r.textContent=e?"Reading…":"Read")}setLearningStatus(e){var n;const r=(n=this.container)==null?void 0:n.querySelector(".lira-sr-learning-status");if(!r)return;if(!e||!e.enabled){r.textContent="Learning off";return}const t=e.recordedThisRead>0?` (+${e.recordedThisRead})`:"";r.textContent=`Learning: ${e.totalObservations} observation${e.totalObservations===1?"":"s"}${t}`}setError(e){var t;const r=(t=this.container)==null?void 0:t.querySelector(".lira-sr-error");r&&(r.textContent=e??"",r.style.display=e?"block":"none")}renderDocument(e){this.documentResult=e.document,this.detailCache.clear(),this.expandedNodes=new Set(["doc"]),this.selectedKey=void 0,this.setLearningStatus(e.learning);const r=_(e.document);if(r){this.selectSentenceNode(r);return}this.renderTreeInPlace(),this.setPanelPlaceholder(".lira-sr-predicted","No sentences found in this text."),this.setPanelPlaceholder(".lira-sr-winner-panel","No sentences found in this text."),this.setPanelPlaceholder(".lira-sr-trace","No sentences found in this text.")}renderDetail(e){var s,i,c;const r=(s=this.container)==null?void 0:s.querySelector(".lira-sr-predicted"),t=(i=this.container)==null?void 0:i.querySelector(".lira-sr-winner-panel"),n=(c=this.container)==null?void 0:c.querySelector(".lira-sr-trace");r&&(r.innerHTML=this.renderPredicted(e.predicted,e.words)),t&&(t.innerHTML=this.renderWinner(e.predicted,e.trace)),n&&(n.innerHTML=this.renderTrace(e.trace))}setPanelPlaceholder(e,r){var n;const t=(n=this.container)==null?void 0:n.querySelector(e);t&&(t.innerHTML=`<div class="lira-sr-placeholder">${l(r)}</div>`)}ensureStyles(){if(document.getElementById(y))return;const e=document.createElement("style");e.id=y,e.textContent=X,document.head.appendChild(e)}renderShell(){return`
    ...
    `}renderTree(e){const r=this.expandedNodes.has("doc"),t=g[e.validation]??"#7A7A7A",n=e.blocks.filter(p=>p.blockKind==="paragraph").length,s=e.blocks.length-n,i=e.blocks.reduce((p,u)=>p+(u.blockKind==="paragraph"?u.errors.length:0),0),c=[`${n} paragraph${n===1?"":"s"}`,s?`${s} heading${s===1?"":"s"}`:"",i?`${i} error${i===1?"":"s"}`:""].filter(Boolean).join(", ");return`
      <ul class="lira-tree-root">
        ...
        </li>`;const n=this.expandedNodes.has(t),s=g[e.validation]??"#7A7A7A",i=[`${e.sentences.length} sentence${e.sentences.length===1?"":"s"}`,e.errors.length?`${e.errors.length} error${e.errors.length===1?"":"s"}`:""].filter(Boolean).join(", ");return`
      <li class="lira-tree-node">
      ...
      </li>`}renderSentenceNode(e,r,t){const n=`${r}s${t}`,s=g[e.validation]??"#7A7A7A";return`
      <li class="lira-tree-node lira-tree-leaf">
      ...
      </li>`}renderWinner(e,r){const t=e.clauses[0],s=(t?[["subject",t.subject],["predicate",t.predicate],["object",t.object],["complement",t.complement],...t.modifiers.map(c=>["modifier",c])]:[]).map(([c,p])=>U(c,p)).join(""),i=r.length?`<div class="lira-sr-winner-positions">
          ${r.map(c=>`
    ...
    `}renderPredicted(e,r){return`${`
      <div class="lira-sr-clause-head">
        ...
        <span class="lira-sr-faint">${e.punctuation?`terminal "${l(e.punctuation)}"`:"no terminal punctuation"}</span>
          ...
          ${e.winnerPartsOfSpeech.map(n=>R(n.text,n.partOfSpeech)).join("")}
        </div>`:"";return`
    ...
    </div>`:""}function x(a,e){return`<button type="button" class="lira-tree-toggle" data-action="toggle-node" data-node="${a}" aria-expanded="${e}">${G}</button>`}function k(a,e){const r=a.trim();return r.length>e?`${r.slice(0,e-1)}…`:r}function j(a){const e=/^b(\d+)s(\d+)$/.exec(a);if(e)return{blockIndex:Number(e[1]),sentenceIndex:Number(e[2])}}function _(a){for(let e=0;e<a.blocks.length;e+=1){const r=a.blocks[e];if(r.blockKind!=="paragraph")continue;const t=r.sentences.findIndex(n=>n.errors.length>0);if(t>=0)return`b${e}s${t}`}for(let e=0;e<a.blocks.length;e+=1){const r=a.blocks[e];if(r.blockKind==="paragraph"&&r.sentences.length>0)return`b${e}s0`}}function H(a){if(!a.length)return'<div class="lira-sr-empty">No words to show.</div>';let e="";return a.forEach((r,t)=>{const n=/^[.,!?;:]+$/.test(r.text);t>0&&!n&&(e+=" "),e+=W(r,t)}),`<div class="lira-sr-sentence">${e}</div>`}function W(a,e){return`<span class="lira-sr-word${a.resolved?"":" lira-sr-word-unfound"}" tabindex="0" data-word-index="${e}">${l(a.text)}${K(a)}</span>`}function K(a){if(!a.resolved)return`<span class="lira-sr-word-tooltip"><span class="tt-title">${l(a.text)}</span><span class="tt-meta">Not found in the Common Vocabulary Cache</span></span>`;const e=[a.validation??"UNRESOLVED",a.phraseType??"no phrase"],r=[a.partOfSpeech??"?",`conf ${a.confidence!==null?a.confidence.toFixed(2):"—"}`];return`<span class="lira-sr-word-tooltip"><span class="tt-title">${l(a.text)}</span><span class="tt-meta">${e.map(l).join(" · ")}</span><span class="tt-meta">${r.map(l).join(" · ")}</span></span>`}function $(a){return`<span class="lira-sr-badge" style="background:${g[a]??"#7A7A7A"}">${l(a)}</span>`}function R(a,e){return`
    <span class="lira-sr-pos-chip" style="background:${P[e]??"#7A7A7A"}">
      <span class="w">${l(a)}</span>
      <span class="p">${l(e)}</span>
    </span>`}function Y(a){return a.length?`<div class="lira-sr-trace-tokens">${a.map(r=>R(r.text,r.partOfSpeech??(r.isMarker?"MARKER":"UNKNOWN"))).join("")}</div>`:""}function J(a){return a.length?`
    ...
    </div>`:""}function l(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const G='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 6l4 4 4-4"/></svg>',X=`
...
`,Q="Common",E=[{id:"vocabulary",label:"Vocabulary",available:!0},{id:"linguistics",label:"Linguistics",available:!0},{id:"knowledge",label:"Knowledge",available:!1}],C="lira-portal-shell-styles",S="lira-vocabulary-fragment-styles";class Z{constructor(e,r,t,n,s={}){o(this,"mode");o(this,"mobileScreen","browse");o(this,"selectedName");o(this,"selectedComponent","vocabulary");o(this,"treeCollapsed",!1);o(this,"title");o(this,"container");o(this,"serviceStatusView");o(this,"sentenceReaderView");o(this,"renderToken",0);o(this,"currentVocabularyDomainName");var i;this.registry=e,this.vocabularyClient=r,this.statusBoard=n,this.title=s.title??"LIRA",this.mode=typeof window<"u"&&window.matchMedia("(max-width: 720px)").matches?"mobile":"desktop",this.selectedName=(i=this.registry.roots()[0])==null?void 0:i.name,this.serviceStatusView=new O(n),this.sentenceReaderView=new q(t),this.statusBoard.subscribe(c=>{const p=c.find(u=>u.id==="vocabulary");p&&this.updateVocabToolbar(p)}),this.vocabularyClient.onDomainUpdated(c=>{this.registry.add(c),this.render()}),this.searchWordsBridge(),this.searchRelationshipsBridge()}searchWordsBridge(){document.addEventListener("lira-search-words",e=>{const r=e.detail;this.currentVocabularyDomainName&&this.vocabularyClient.searchWords(this.currentVocabularyDomainName,{word:r.word,gloss:r.gloss,definition:r.definition,pos:r.pos,domainLabel:r.domain,rootWordsOnly:r.rootWordsOnly,limit:r.limit}).then(t=>{document.dispatchEvent(new CustomEvent("lira-search-words-result",{detail:{requestId:r.requestId,words:t.words,totalMatches:t.totalMatches}}))})})}searchRelationshipsBridge(){document.addEventListener("lira-search-relationships",e=>{const r=e.detail;this.currentVocabularyDomainName&&this.vocabularyClient.searchRelationships(this.currentVocabularyDomainName,{wordId:r.wordId,query:r.query,limit:r.limit}).then(t=>{document.dispatchEvent(new CustomEvent("lira-search-relationships-result",{detail:{requestId:r.requestId,relationships:t.relationships,totalMatches:t.totalMatches}}))})})}mount(e){this.container=e,document.title=this.title,this.ensureStyles(),e.addEventListener("click",r=>this.handleClick(r)),this.render()}handleClick(e){const r=e.target.closest("[data-action]");if(!r||r.disabled)return;const t=r.dataset.action;t==="select"?(this.selectedName=r.dataset.domain,this.mode==="mobile"&&(this.mobileScreen="view"),this.render()):t==="mode"?(this.mode=r.dataset.mode,this.mode==="mobile"&&(this.mobileScreen=this.selectedName?"view":"browse"),this.render()):t==="back"?(this.mobileScreen="browse",this.render()):t==="component"?(this.selectedComponent=r.dataset.component,this.render()):t==="toggle-tree"?(this.treeCollapsed=!this.treeCollapsed,this.render()):t==="seed-wordnet"&&this.vocabularyClient.seedWordNet(Q)}renderVocabToolbar(){return`<div class="portal-vocab-toolbar">${this.vocabToolbarInner(this.statusBoard.get("vocabulary"))}</div>`}vocabToolbarInner(e){const r=(e==null?void 0:e.state)==="running",t=e==null?void 0:e.progress;return`
    ...
    `}updateVocabToolbar(e){var t;const r=(t=this.container)==null?void 0:t.querySelector(".portal-vocab-toolbar");r&&(r.innerHTML=this.vocabToolbarInner(e))}ensureStyles(){if(document.getElementById(C))return;const e=document.createElement("style");e.id=C,e.textContent=de,document.head.appendChild(e)}ensureFragmentStyles(e){if(document.getElementById(S))return;const r=document.createElement("style");r.id=S,r.textContent=e,document.head.appendChild(r)}render(){if(!this.container)return;const e=this.selectedName?this.registry.get(this.selectedName):void 0;this.renderToken++;const r=this.mode==="desktop"&&this.treeCollapsed?"tree-collapsed":"";this.container.innerHTML=`
    ...
    `;const t=this.container.querySelector(".portal-service-status");t&&this.serviceStatusView.mount(t),e&&this.selectedComponent==="vocabulary"?this.loadView(e):e&&this.selectedComponent==="linguistics"&&this.loadLinguisticsView()}loadLinguisticsView(){if(!this.container)return;const e=this.container.querySelector(".portal-fragment-mount");e&&this.sentenceReaderView.mount(e)}async loadView(e){const r=++this.renderToken;this.setViewStatus("Loading Vocabulary…");let t;try{t=await this.vocabularyClient.renderDomain(e.name)}catch(s){if(r!==this.renderToken)return;this.setViewStatus(`Couldn't load this Domain's Vocabulary view: ${s instanceof Error?s.message:String(s)}`);return}if(r!==this.renderToken||!this.container)return;this.ensureFragmentStyles(t.style);const n=this.container.querySelector(".portal-fragment-mount");if(n){n.innerHTML=t.body,this.currentVocabularyDomainName=e.name;const s=document.createElement("script");s.textContent=`(function () {
${t.script}
})();`,n.appendChild(s)}this.setViewStatus(void 0)}setViewStatus(e){var t;const r=(t=this.container)==null?void 0:t.querySelector(".portal-view-status");r&&(r.textContent=e??"",r.style.display=e?"block":"none")}renderTopbar(e){const r=`
      <div class="portal-mode-toggle" role="group" aria-label="Layout">
        <button type="button" data-action="mode" data-mode="desktop" class="${this.mode==="desktop"?"active":""}">${se} Desktop</button>
        <button type="button" data-action="mode" data-mode="mobile" class="${this.mode==="mobile"?"active":""}">${ie} Mobile</button>
          ...
          <div class="portal-topbar">
            <button type="button" class="portal-back" data-action="back" aria-label="Back to Domains">${ae}</button>
            <span class="portal-topbar-title">${h(e.name)}</span>
            ${r}
          </div>`:`<div class="portal-topbar"><span class="portal-topbar-title">All Domains</span>${r}</div>`;const t=e?this.registry.ancestryOf(e.name):[];return`<div class="portal-topbar"><nav class="portal-breadcrumb">${[`<span class="crumb-root">${ne} All Domains</span>`,...t.map(s=>`<span>${h(s.name)}</span>`)].join(`<span class="crumb-sep">${te}</span>`)}</nav>${r}</div>`}renderBody(e){return this.mode==="desktop"?`${this.renderTree()}${this.renderViewPane(e)}`:this.mobileScreen==="browse"?`<div class="portal-tree portal-tree--mobile">${this.renderTreeRows(0)}</div>`:this.renderViewPane(e,!0)}renderTree(){return this.treeCollapsed?`
      ...
      </nav>`}renderTreeRows(e,r){return(e===0?this.registry.roots():this.registry.children(r??"")).map(n=>{const s=this.registry.children(n.name),i=n.name===this.selectedName;return`
          <div class="portal-tree-row depth-${e} ${i?"selected":""}" data-action="select" data-domain="${h(n.name)}">
            ${s.length>0?re:'<span class="chev-spacer"></span>'}
            ${ee}
            <span class="name">${h(n.name)}</span>
            <span class="count">${n.wordCount.toLocaleString()}</span>
          </div>
          ${s.length>0?this.renderTreeRows(e+1,n.name):""}
      ...
      <div class="portal-component-switcher" role="tablist" aria-label="UI Component">
        ...
        `).join("")}
      </div>`}renderViewPane(e,r=!1){const t=this.renderComponentSwitcher(),n='<div class="portal-service-status"></div>',s=this.selectedComponent==="vocabulary"?this.renderVocabToolbar():"";if(!e)return`
        <div class="portal-view ${r?"portal-view--full":""}">
          ${t}
          ${s}
          <div class="portal-view-empty">Select a Domain to continue.</div>
          ${n}
        </div>`;const i=E.find(p=>p.id===this.selectedComponent),c=i!=null&&i.available?`
...
`;class ce{constructor(){o(this,"worker");o(this,"statusListeners",new Set);o(this,"domainUpdateListeners",new Set);o(this,"readyResolvers",[]);o(this,"pendingRenders",new Map);o(this,"pendingSearches",new Map);o(this,"pendingRelationshipSearches",new Map);this.worker=new Worker(new URL(""+new URL("vocabulary_worker-B4IbsYEw.js",import.meta.url).href,import.meta.url),{type:"module"}),this.worker.addEventListener("message",e=>{this.handleMessage(e.data)})}onStatus(e){return this.statusListeners.add(e),()=>{this.statusListeners.delete(e)}}init(){return new Promise(e=>{this.readyResolvers.push(e),this.post({type:"init"})})}renderDomain(e){const r=`${e}-${Math.random().toString(36).slice(2)}`;return new Promise((t,n)=>{this.pendingRenders.set(r,{resolve:t,reject:n}),this.post({type:"render",requestId:r,domain:e})})}seedWordNet(e){this.post({type:"seed-wordnet",domain:e})}onDomainUpdated(e){return this.domainUpdateListeners.add(e),()=>{this.domainUpdateListeners.delete(e)}}searchWords(e,r){const t=`search-${e}-${Math.random().toString(36).slice(2)}`;return new Promise(n=>{this.pendingSearches.set(t,n),this.post({type:"search-words",requestId:t,domain:e,word:r.word,gloss:r.gloss,definition:r.definition,pos:r.pos,domainLabel:r.domainLabel,rootWordsOnly:r.rootWordsOnly,limit:r.limit})})}searchRelationships(e,r){const t=`rel-search-${e}-${Math.random().toString(36).slice(2)}`;return new Promise(n=>{this.pendingRelationshipSearches.set(t,n),this.post({type:"search-relationships",requestId:t,domain:e,wordId:r.wordId,query:r.query,limit:r.limit})})}post(e){this.worker.postMessage(e)}handleMessage(e){if(e.type==="status")for(const r of this.statusListeners)r(e.state,e.detail,e.progress);else if(e.type==="ready"){const r=this.readyResolvers.splice(0);for(const t of r)t(e.domains)}else if(e.type==="rendered"){const r=this.pendingRenders.get(e.requestId);r&&(this.pendingRenders.delete(e.requestId),r.resolve(e.fragment))}else if(e.type==="render-error"){const r=this.pendingRenders.get(e.requestId);r&&(this.pendingRenders.delete(e.requestId),r.reject(new Error(e.message)))}else if(e.type==="domain-updated")for(const r of this.domainUpdateListeners)r(e.domain);else if(e.type==="search-words-result"){const r=this.pendingSearches.get(e.requestId);r&&(this.pendingSearches.delete(e.requestId),r({words:e.words,totalMatches:e.totalMatches}))}else if(e.type==="search-relationships-result"){const r=this.pendingRelationshipSearches.get(e.requestId);r&&(this.pendingRelationshipSearches.delete(e.requestId),r({relationships:e.relationships,totalMatches:e.totalMatches}))}else e.type==="error"&&console.error("Vocabulary Service error:",e.message)}}class pe{constructor(){o(this,"worker");o(this,"statusListeners",new Set);o(this,"readyResolvers",[]);o(this,"pendingReads",new Map);o(this,"pendingReadDocuments",new Map);this.worker=new Worker(new URL(""+new URL("linguistics_worker-oRyIsuP2.js",import.meta.url).href,import.meta.url),{type:"module"}),this.worker.addEventListener("message",e=>{this.handleMessage(e.data)})}onStatus(e){return this.statusListeners.add(e),()=>{this.statusListeners.delete(e)}}init(){return new Promise(e=>{this.readyResolvers.push(e),this.post({type:"init"})})}read(e,r,t=!1){const n=`read-${Math.random().toString(36).slice(2)}`;return new Promise((s,i)=>{this.pendingReads.set(n,{resolve:s,reject:i}),this.post({type:"read",requestId:n,text:e,learningEnabled:r,skipLearning:t})})}readDocument(e,r){const t=`read-doc-${Math.random().toString(36).slice(2)}`;return new Promise((n,s)=>{this.pendingReadDocuments.set(t,{resolve:n,reject:s}),this.post({type:"read-document",requestId:t,text:e,learningEnabled:r})})}post(e){this.worker.postMessage(e)}handleMessage(e){if(e.type==="status")for(const r of this.statusListeners)r(e.state,e.detail);else if(e.type==="ready"){const r=this.readyResolvers.splice(0);for(const t of r)t(e.wordCount)}else if(e.type==="read-result"){const r=this.pendingReads.get(e.requestId);r&&(this.pendingReads.delete(e.requestId),r.resolve(e.result))}else if(e.type==="read-document-result"){const r=this.pendingReadDocuments.get(e.requestId);r&&(this.pendingReadDocuments.delete(e.requestId),r.resolve(e.result))}else if(e.type==="error"){if(e.requestId){const r=this.pendingReads.get(e.requestId);if(r){this.pendingReads.delete(e.requestId),r.reject(new Error(e.message));return}const t=this.pendingReadDocuments.get(e.requestId);if(t){this.pendingReadDocuments.delete(e.requestId),t.reject(new Error(e.message));return}}console.error("Linguistic Service error:",e.message)}}}function ue(){const a=document.querySelector("#app");if(!a)return;a.style.height="100vh";const e=new T;e.register("vocabulary","Vocabulary Service","idle","Starting…"),e.register("linguistics","Linguistic Service","idle","Starting…"),e.register("knowledge","Knowledge Service","not-ported");const r=new B(e,"LIRA");r.mount(a);const t=new ce;t.onStatus((s,i,c)=>e.update("vocabulary",s,i,c));const n=new pe;n.onStatus((s,i)=>e.update("linguistics",s,i)),Promise.all([t.init(),n.init()]).then(([s])=>{r.destroy();const i=new L(s);new Z(i,t,n,e,{title:"LIRA"}).mount(a)}).catch(s=>{e.update("vocabulary","error",s instanceof Error?s.message:String(s))})}ue();
