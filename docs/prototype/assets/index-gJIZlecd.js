var N=Object.defineProperty;var T=(a,e,r)=>e in a?N(a,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):a[e]=r;var o=(a,e,r)=>T(a,typeof e!="symbol"?e+"":e,r);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&t(s)}).observe(document,{childList:!0,subtree:!0});function r(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function t(n){if(n.ep)return;n.ep=!0;const i=r(n);fetch(n.href,i)}})();class L{constructor(){o(this,"statuses",new Map);o(this,"listeners",new Set)}register(e,r,t="idle",n){this.statuses.set(e,{id:e,label:r,state:t,detail:n}),this.notify()}update(e,r,t,n){const i=this.statuses.get(e);i&&(this.statuses.set(e,{...i,state:r,detail:t,progress:n}),this.notify())}get(e){return this.statuses.get(e)}all(){return[...this.statuses.values()]}subscribe(e){return this.listeners.add(e),e(this.all()),()=>{this.listeners.delete(e)}}notify(){const e=this.all();for(const r of this.listeners)r(e)}}class B{constructor(e=[]){o(this,"domains",new Map);for(const r of e)this.add(r)}add(e){this.domains.set(e.name,e)}get(e){return this.domains.get(e)}all(){return[...this.domains.values()]}roots(){return this.all().filter(e=>e.parentName===void 0)}children(e){return this.all().filter(r=>r.parentName===e)}ancestryOf(e){const r=[];let t=this.get(e);for(;t!==void 0;)r.unshift(t),t=t.parentName!==void 0?this.get(t.parentName):void 0;return r}}class A{constructor(e,r="LIRA"){o(this,"unsubscribe");this.board=e,this.title=r}mount(e){var r;this.ensureStyles(),(r=this.unsubscribe)==null||r.call(this),this.unsubscribe=this.board.subscribe(t=>{e.innerHTML=this.renderScreen(t)})}waitFor(...e){return new Promise(r=>{const t=s=>s==="done"||s==="error",n=s=>{const c=s.filter(p=>e.includes(p.id));c.length===e.length&&c.every(p=>t(p.state))&&(i(),r())},i=this.board.subscribe(n)})}destroy(){var e;(e=this.unsubscribe)==null||e.call(this),this.unsubscribe=void 0}renderScreen(e){return`
    ...
    `}ensureStyles(){if(document.getElementById(v))return;const e=document.createElement("style");e.id=v,e.textContent=F,document.head.appendChild(e)}}const D={"not-ported":"Not ported yet",idle:"Waiting…",running:"Working…",done:"Ready",error:"Failed"},M={"not-ported":"–",idle:"○",running:'<span class="loading-spinner"></span>',done:"✓",error:"✕"};function f(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const v="lira-loading-screen-styles",F=`
.loading-screen {
...
`;class O{constructor(e,r=[]){o(this,"unsubscribe");o(this,"collapsed",!1);this.board=e,this.actions=r}mount(e){var r;this.ensureStyles(),(r=this.unsubscribe)==null||r.call(this),e.addEventListener("click",t=>this.handleClick(t,e)),this.unsubscribe=this.board.subscribe(t=>{e.innerHTML=this.renderPanel(t)})}destroy(){var e;(e=this.unsubscribe)==null||e.call(this),this.unsubscribe=void 0}handleClick(e,r){const t=e.target.closest("[data-action]");if(!(!t||t.disabled)){if(t.dataset.action==="toggle")this.collapsed=!this.collapsed,r.innerHTML=this.renderPanel(this.board.all());else if(t.dataset.action==="run"){const n=this.actions.find(i=>i.id===t.dataset.actionId);n==null||n.onClick()}}}renderPanel(e){const r=e.filter(t=>t.state==="running"||t.state==="done").length;return`
    ...
    `}renderRow(e){const r=this.actions.find(n=>n.id===e.id),t=e.progress!==void 0?`<div class="service-status-progress"><div class="service-status-progress-fill" style="width:${Math.round(e.progress*100)}%"></div></div>`:"";return`
      <div class="service-status-row-group">
        <div class="service-status-row state-${e.state}">
          ...
          <span class="service-status-pill">${V[e.state]}</span>
    ...
    `}ensureStyles(){if(document.getElementById(b))return;const e=document.createElement("style");e.id=b,e.textContent=P,document.head.appendChild(e)}}const V={"not-ported":"Not ported",idle:"Idle",running:"Running",done:"Running",error:"Error"};function m(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const z='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 6l4 4 4-4"/></svg>',b="lira-service-status-styles",P=`
...
`;var d=(a=>(a[a.NOUN=0]="NOUN",a[a.VERB=1]="VERB",a[a.ADJECTIVE=2]="ADJECTIVE",a[a.ADVERB=3]="ADVERB",a[a.PRONOUN=4]="PRONOUN",a[a.DETERMINER=5]="DETERMINER",a[a.PREPOSITION=6]="PREPOSITION",a[a.CONJUNCTION=7]="CONJUNCTION",a[a.INTERJECTION=8]="INTERJECTION",a[a.NUMERAL=9]="NUMERAL",a[a.PARTICLE=10]="PARTICLE",a[a.AUXILIARY=11]="AUXILIARY",a[a.PROPER_NOUN=12]="PROPER_NOUN",a[a.SYMBOL=13]="SYMBOL",a[a.PUNCTUATION=14]="PUNCTUATION",a[a.OTHER=15]="OTHER",a))(d||{});const q={[d[d.NOUN]]:"#3B6EA5",[d[d.PROPER_NOUN]]:"#274472",[d[d.VERB]]:"#B2542D",[d[d.ADJECTIVE]]:"#7A5CA6",[d[d.ADVERB]]:"#B08900",[d[d.PRONOUN]]:"#5B7B6F",[d[d.DETERMINER]]:"#6E7B8B",[d[d.PREPOSITION]]:"#7B6E5B",[d[d.CONJUNCTION]]:"#6B7280",[d[d.PARTICLE]]:"#8A7B6E",[d[d.AUXILIARY]]:"#5B6E8B",[d[d.INTERJECTION]]:"#C2544B",[d[d.NUMERAL]]:"#4B8A7B",[d[d.SYMBOL]]:"#8A8A8A",[d[d.PUNCTUATION]]:"#9A9A9A",[d[d.OTHER]]:"#7A7A7A"},g={VALID:"#2B6E63",UNRESOLVED:"#B08900",INVALID:"#B2542D"},w=["A meaning is a representation.","The word over the meaning.","The use is a state.","The word wants to use the meaning.","The meaning and the word perceive the state."],y="lira-sentence-reader-styles";class H{constructor(e){o(this,"container");o(this,"reading",!1);o(this,"requestToken",0);o(this,"documentResult");o(this,"expandedNodes",new Set);o(this,"selectedKey");o(this,"detailCache",new Map);o(this,"detailToken",0);this.client=e}mount(e){this.container=e,this.ensureStyles(),e.innerHTML=this.renderShell(),this.wire();const r=e.querySelector(".lira-sr-textarea");r!=null&&r.value&&this.read(r.value)}destroy(){this.container=void 0}wire(){const e=this.container;if(!e)return;const r=e.querySelector(".lira-sr-textarea"),t=e.querySelector(".lira-sr-read-btn");r&&t&&(t.addEventListener("click",()=>void this.read(r.value)),r.addEventListener("keydown",i=>{(i.metaKey||i.ctrlKey)&&i.key==="Enter"&&this.read(r.value)})),e.querySelectorAll(".lira-sr-example").forEach(i=>{i.addEventListener("click",()=>{const s=i.dataset.example??"";r&&(r.value=s),this.read(s)})});const n=e.querySelector(".lira-sr-tree");n==null||n.addEventListener("click",i=>this.handleTreeClick(i)),n==null||n.addEventListener("keydown",i=>this.handleTreeKeydown(i))}handleTreeClick(e){const r=e.target,t=r.closest('[data-action="toggle-node"]');if(t){this.toggleNode(t.dataset.node??"");return}const n=r.closest('.lira-tree-row[data-kind="sentence"]');n&&this.selectSentenceNode(n.dataset.node??"")}handleTreeKeydown(e){if(e.key!=="Enter"&&e.key!==" ")return;const r=e.target.closest('.lira-tree-row[data-kind="sentence"]');r&&(e.preventDefault(),this.selectSentenceNode(r.dataset.node??""))}toggleNode(e){!e||!this.documentResult||(this.expandedNodes.has(e)?this.expandedNodes.delete(e):this.expandedNodes.add(e),this.renderTreeInPlace())}renderTreeInPlace(){var r;if(!this.documentResult)return;const e=(r=this.container)==null?void 0:r.querySelector(".lira-sr-tree");e&&(e.innerHTML=this.renderTree(this.documentResult))}async selectSentenceNode(e){const r=this.documentResult,t=j(e);if(!r||!t)return;const n=r.blocks[t.blockIndex];if(!n||n.blockKind!=="paragraph")return;const i=n.sentences[t.sentenceIndex];if(!i)return;this.selectedKey=e,this.expandedNodes.add(`b${t.blockIndex}`),this.renderTreeInPlace();const s=this.detailCache.get(e);if(s){this.renderDetail(s);return}this.setPanelPlaceholder(".lira-sr-predicted","Loading…"),this.setPanelPlaceholder(".lira-sr-winner-panel","Loading…"),this.setPanelPlaceholder(".lira-sr-trace","Loading…");const c=++this.detailToken,p=this.isLearningEnabled();try{const u=await this.client.read(i.text,p,!0);if(c!==this.detailToken||!this.container)return;this.detailCache.set(e,u),this.renderDetail(u)}catch(u){if(c!==this.detailToken||!this.container)return;this.setError(u instanceof Error?u.message:String(u))}}isLearningEnabled(){var r;const e=(r=this.container)==null?void 0:r.querySelector(".lira-sr-learning-toggle");return(e==null?void 0:e.checked)??!0}async read(e){const r=e.trim();if(!r||this.reading)return;const t=++this.requestToken,n=this.isLearningEnabled();this.reading=!0,this.setBusy(!0),this.setError(void 0);try{const i=await this.client.readDocument(r,n);if(t!==this.requestToken||!this.container)return;this.renderDocument(i)}catch(i){if(t!==this.requestToken||!this.container)return;this.setError(i instanceof Error?i.message:String(i))}finally{t===this.requestToken&&(this.reading=!1,this.setBusy(!1))}}setBusy(e){var t;const r=(t=this.container)==null?void 0:t.querySelector(".lira-sr-read-btn");r&&(r.disabled=e,r.textContent=e?"Reading…":"Read")}setLearningStatus(e){var n;const r=(n=this.container)==null?void 0:n.querySelector(".lira-sr-learning-status");if(!r)return;if(!e||!e.enabled){r.textContent="Learning off";return}const t=e.recordedThisRead>0?` (+${e.recordedThisRead})`:"";r.textContent=`Learning: ${e.totalObservations} observation${e.totalObservations===1?"":"s"}${t}`}setError(e){var t;const r=(t=this.container)==null?void 0:t.querySelector(".lira-sr-error");r&&(r.textContent=e??"",r.style.display=e?"block":"none")}renderDocument(e){this.documentResult=e.document,this.detailCache.clear(),this.expandedNodes=new Set(["doc"]),this.selectedKey=void 0,this.setLearningStatus(e.learning);const r=_(e.document);if(r){this.selectSentenceNode(r);return}this.renderTreeInPlace(),this.setPanelPlaceholder(".lira-sr-predicted","No sentences found in this text."),this.setPanelPlaceholder(".lira-sr-winner-panel","No sentences found in this text."),this.setPanelPlaceholder(".lira-sr-trace","No sentences found in this text.")}renderDetail(e){var i,s,c;const r=(i=this.container)==null?void 0:i.querySelector(".lira-sr-predicted"),t=(s=this.container)==null?void 0:s.querySelector(".lira-sr-winner-panel"),n=(c=this.container)==null?void 0:c.querySelector(".lira-sr-trace");r&&(r.innerHTML=this.renderPredicted(e.predicted,e.words)),t&&(t.innerHTML=this.renderWinner(e.predicted,e.trace)),n&&(n.innerHTML=this.renderTrace(e.trace))}setPanelPlaceholder(e,r){var n;const t=(n=this.container)==null?void 0:n.querySelector(e);t&&(t.innerHTML=`<div class="lira-sr-placeholder">${l(r)}</div>`)}ensureStyles(){if(document.getElementById(y))return;const e=document.createElement("style");e.id=y,e.textContent=Q,document.head.appendChild(e)}renderShell(){return`
    ...
    `}renderTree(e){const r=this.expandedNodes.has("doc"),t=g[e.validation]??"#7A7A7A",n=e.blocks.filter(p=>p.blockKind==="paragraph").length,i=e.blocks.length-n,s=e.blocks.reduce((p,u)=>p+(u.blockKind==="paragraph"?u.errors.length:0),0),c=[`${n} paragraph${n===1?"":"s"}`,i?`${i} heading${i===1?"":"s"}`:"",s?`${s} error${s===1?"":"s"}`:""].filter(Boolean).join(", ");return`
      <ul class="lira-tree-root">
        ...
        </li>`;const n=this.expandedNodes.has(t),i=g[e.validation]??"#7A7A7A",s=[`${e.sentences.length} sentence${e.sentences.length===1?"":"s"}`,e.errors.length?`${e.errors.length} error${e.errors.length===1?"":"s"}`:""].filter(Boolean).join(", ");return`
      <li class="lira-tree-node">
        <div class="lira-tree-row" data-node="${t}" data-kind="paragraph">
          ...
          ${n?"":`<span class="lira-tree-summary">${l(s)}</span>`}
        </div>
        ${n?`<ul>${e.sentences.map((c,p)=>this.renderSentenceNode(c,t,p)).join("")}</ul>`:""}
      </li>`}renderSentenceNode(e,r,t){const n=`${r}s${t}`,i=g[e.validation]??"#7A7A7A";return`
      <li class="lira-tree-node lira-tree-leaf">
      ...
      </li>`}renderWinner(e,r){const t=e.clauses[0],i=(t?[["subject",t.subject],["predicate",t.predicate],["object",t.object],["complement",t.complement],...t.modifiers.map(c=>["modifier",c])]:[]).map(([c,p])=>U(c,p)).join(""),s=r.length?`<div class="lira-sr-winner-positions">
          ${r.map(c=>`
    ...
    </div>`:""}function l(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const X='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 6l4 4 4-4"/></svg>',Q=`
...
`,E="Common",C=[{id:"vocabulary",label:"Vocabulary",available:!0},{id:"linguistics",label:"Linguistics",available:!0},{id:"knowledge",label:"Knowledge",available:!1}],I="lira-portal-shell-styles",S="lira-vocabulary-fragment-styles";class Z{constructor(e,r,t,n,i={}){o(this,"mode");o(this,"mobileScreen","browse");o(this,"selectedName");o(this,"selectedComponent","vocabulary");o(this,"treeCollapsed",!1);o(this,"title");o(this,"container");o(this,"serviceStatusView");o(this,"sentenceReaderView");o(this,"renderToken",0);o(this,"currentVocabularyDomainName");var s;this.registry=e,this.vocabularyClient=r,this.statusBoard=n,this.title=i.title??"LIRA",this.mode=typeof window<"u"&&window.matchMedia("(max-width: 720px)").matches?"mobile":"desktop",this.selectedName=(s=this.registry.roots()[0])==null?void 0:s.name,this.serviceStatusView=new O(n),this.sentenceReaderView=new H(t),this.statusBoard.subscribe(c=>{const p=c.find(u=>u.id==="vocabulary");p&&this.updateVocabToolbar(p)}),this.vocabularyClient.onDomainUpdated(c=>{this.registry.add(c),this.render()}),this.searchWordsBridge(),this.searchRelationshipsBridge(),this.resolveHierarchyBridge()}searchWordsBridge(){document.addEventListener("lira-search-words",e=>{const r=e.detail;this.currentVocabularyDomainName&&this.vocabularyClient.searchWords(this.currentVocabularyDomainName,{wordId:r.wordId,word:r.word,gloss:r.gloss,definition:r.definition,pos:r.pos,domainLabel:r.domain,rootWordsOnly:r.rootWordsOnly,limit:r.limit}).then(t=>{document.dispatchEvent(new CustomEvent("lira-search-words-result",{detail:{requestId:r.requestId,words:t.words,totalMatches:t.totalMatches}}))})})}searchRelationshipsBridge(){document.addEventListener("lira-search-relationships",e=>{const r=e.detail;this.currentVocabularyDomainName&&this.vocabularyClient.searchRelationships(this.currentVocabularyDomainName,{wordId:r.wordId,query:r.query,limit:r.limit}).then(t=>{document.dispatchEvent(new CustomEvent("lira-search-relationships-result",{detail:{requestId:r.requestId,relationships:t.relationships,totalMatches:t.totalMatches}}))})})}resolveHierarchyBridge(){document.addEventListener("lira-resolve-hierarchy",e=>{const r=e.detail;this.currentVocabularyDomainName&&this.vocabularyClient.resolveHierarchy(this.currentVocabularyDomainName,{kind:r.kind,wordId:r.wordId,limit:r.limit}).then(t=>{document.dispatchEvent(new CustomEvent("lira-resolve-hierarchy-result",{detail:{requestId:r.requestId,...t}}))})})}mount(e){this.container=e,document.title=this.title,this.ensureStyles(),e.addEventListener("click",r=>this.handleClick(r)),this.render()}handleClick(e){const r=e.target.closest("[data-action]");if(!r||r.disabled)return;const t=r.dataset.action;t==="select"?(this.selectedName=r.dataset.domain,this.mode==="mobile"&&(this.mobileScreen="view"),this.render()):t==="mode"?(this.mode=r.dataset.mode,this.mode==="mobile"&&(this.mobileScreen=this.selectedName?"view":"browse"),this.render()):t==="back"?(this.mobileScreen="browse",this.render()):t==="component"?(this.selectedComponent=r.dataset.component,this.render()):t==="toggle-tree"?(this.treeCollapsed=!this.treeCollapsed,this.render()):t==="seed-wordnet"?this.vocabularyClient.seedWordNet(E):t==="seed-common-vocabulary"&&this.vocabularyClient.seedCommonVocabulary(E)}renderVocabToolbar(){return`<div class="portal-vocab-toolbar">${this.vocabToolbarInner(this.statusBoard.get("vocabulary"))}</div>`}vocabToolbarInner(e){const r=(e==null?void 0:e.state)==="running",t=e==null?void 0:e.progress;return`
    ...
    `;const t=this.container.querySelector(".portal-service-status");t&&this.serviceStatusView.mount(t),e&&this.selectedComponent==="vocabulary"?this.loadView(e):e&&this.selectedComponent==="linguistics"&&this.loadLinguisticsView()}loadLinguisticsView(){if(!this.container)return;const e=this.container.querySelector(".portal-fragment-mount");e&&this.sentenceReaderView.mount(e)}async loadView(e){const r=++this.renderToken;this.setViewStatus("Loading Vocabulary…");let t;try{t=await this.vocabularyClient.renderDomain(e.name)}catch(i){if(r!==this.renderToken)return;this.setViewStatus(`Couldn't load this Domain's Vocabulary view: ${i instanceof Error?i.message:String(i)}`);return}if(r!==this.renderToken||!this.container)return;this.ensureFragmentStyles(t.style);const n=this.container.querySelector(".portal-fragment-mount");if(n){n.innerHTML=t.body,this.currentVocabularyDomainName=e.name;const i=document.createElement("script");i.textContent=`(function () {
${t.script}
})();`,n.appendChild(i)}this.setViewStatus(void 0)}setViewStatus(e){var t;const r=(t=this.container)==null?void 0:t.querySelector(".portal-view-status");r&&(r.textContent=e??"",r.style.display=e?"block":"none")}renderTopbar(e){const r=`
      <div class="portal-mode-toggle" role="group" aria-label="Layout">
        <button type="button" data-action="mode" data-mode="desktop" class="${this.mode==="desktop"?"active":""}">${ie} Desktop</button>
        <button type="button" data-action="mode" data-mode="mobile" class="${this.mode==="mobile"?"active":""}">${se} Mobile</button>
          ...
          <div class="portal-topbar">
            ...
            ${r}
          </div>`:`<div class="portal-topbar"><span class="portal-topbar-title">All Domains</span>${r}</div>`;const t=e?this.registry.ancestryOf(e.name):[];return`<div class="portal-topbar"><nav class="portal-breadcrumb">${[`<span class="crumb-root">${ne} All Domains</span>`,...t.map(i=>`<span>${h(i.name)}</span>`)].join(`<span class="crumb-sep">${te}</span>`)}</nav>${r}</div>`}renderBody(e){return this.mode==="desktop"?`${this.renderTree()}${this.renderViewPane(e)}`:this.mobileScreen==="browse"?`<div class="portal-tree portal-tree--mobile">${this.renderTreeRows(0)}</div>`:this.renderViewPane(e,!0)}renderTree(){return this.treeCollapsed?`
      ...
      </nav>`}renderTreeRows(e,r){return(e===0?this.registry.roots():this.registry.children(r??"")).map(n=>{const i=this.registry.children(n.name),s=n.name===this.selectedName;return`
          <div class="portal-tree-row depth-${e} ${s?"selected":""}" data-action="select" data-domain="${h(n.name)}">
            ${i.length>0?re:'<span class="chev-spacer"></span>'}
            ${ee}
            <span class="name">${h(n.name)}</span>
            <span class="count">${n.wordCount.toLocaleString()}</span>
          </div>
          ${i.length>0?this.renderTreeRows(e+1,n.name):""}
